...
class DataAwal extends Component {
  ...
  createPost(hashawal,jeniskopi,petani,tanam,keterangan,tanggal) {
    this.setState({ loading: true })
    this.state.addhash.methods.createPost(hashawal,jeniskopi,petani,tanam,keterangan,tanggal).send({ from: this.state.account })
