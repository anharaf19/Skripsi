...
import Main2 from './MainTelusurTelusur'
...
class DataTelusur extends Component {
  ...
  createPost(hashawal,hashtelusur) {
    this.setState({ loading: true })
    this.state.addhash2.methods.createPost(hashawal,hashtelusur).send({ from: this.state.account })
